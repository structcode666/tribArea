...
# def plot_building_elements(columns, walls, voronoi_polygons=None, slab_outline=None):
#     """
#     Plots the slab outline, columns, walls, and optional Voronoi polygons using matplotlib.

#     Args:
#         slab_outline (Polygon): Shapely polygon representing the slab outline.
#         columns (list): List of Shapely polygons representing columns.
#         walls (list): List of Shapely polygons representing walls.
#         voronoi_polygons (GeometryCollection, optional): Voronoi polygons trimmed to the slab outline.
#     """
#     fig, ax = plt.subplots(figsize=(10, 10))

#     # Plot slab outline
#     if slab_outline:
#         x, y = slab_outline.exterior.xy
...
#     if voronoi_polygons:
#         for idx, v_poly in enumerate(voronoi_polygons):
